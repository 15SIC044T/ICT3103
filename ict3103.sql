...
INSERT INTO `account` (`accountID`, `name`, `email`, `password`, `phone`, `accountStatus`, `verificationToken`, `resetPasswordToken`, `failLoginCount`, `failLoginTime`, `publicKey`) VALUES
(1, 'Xinyi', '15SIC044T@sit.singaporetech.edu.sg', '$2y$10$wLd1Bd9yZD5RDb4IAB1pSOkyaroR6Xum33jsa9j7G5asa6IF97V5m', '12345678', 'Verified', NULL, NULL, 0, NULL, '../keys/rsa/Xinyi_2017-10-21_15-31-26_public.key'),
(2, 'Meng', 'menghwee.pek_2015@sit.singaporetech.edu.sg', '$2y$10$pF.oSYsqSo2Q0mD5J7.y8uCzi.v7YbXU0QPdN0/0X7W0jvfg4Ba3S', '98765432', 'Verified', NULL, NULL, 0, NULL, '../keys/rsa/Meng_2017-10-21_15-33-38_public.key'),
(3, 'jeremy', '15SIS040D@sit.singaporetech.edu.sg', '$2y$10$YwCJDxYyE8hUotSFrH8T/OMOgzaHn8iDr1quLgtxbrDXDYxXgl7cW', '82332779', 'Verified', NULL, NULL, 0, NULL, '../keys/rsa/jeremy_2017-10-21_03-47-10_public.key');
